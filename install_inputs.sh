...
mkdir INPUTS
wget --progress=dot:mega http://mcc.lip6.fr/archives/2019/mcc2019-input.vmdk.tar.bz2
...
# create oracle files
mkdir oracle
wget --progress=dot:mega https://mcc.lip6.fr/archives/2019/raw-result-analysis.csv.zip
